...
region 'us-east-1'
JOB CREATE auto_copy_sales_order_header AUTO OFF;
...
json 'auto ignorecase'
region 'us-east-1'
JOB CREATE auto_copy_sales_order_item AUTO OFF;
...
json 'auto ignorecase'
region 'us-east-1'
JOB CREATE auto_copy_delivery_header AUTO OFF;
...
json 'auto ignorecase'
region 'us-east-1'
JOB CREATE auto_copy_delivery_item AUTO OFF;
...
json 'auto ignorecase'
region 'us-east-1'
JOB CREATE auto_copy_billing_document_header AUTO OFF;
...
json 'auto ignorecase'
region 'us-east-1'
JOB CREATE auto_copy_billing_document_item AUTO OFF;
